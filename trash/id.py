...
custom_headers={"Accept" : "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8","Connection" : "keep-alive","Host" : f'zalegoacademy.ac.ke', "User-Agent" : "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:87.0) Gecko/20100101 Firefox/87.0","Cookie":cookie}
...
if (len(arguments) > 1):
	...
	print(f"  NOTE\t\t:\tSaves the results in the same folder as the script")